---
description: Avalia um projeto, ideia ou repositório e recomenda os agents, skills, plugins e ferramentas MCP mais adequados
argument-hint: [descrição livre do projeto ou objetivo]
---
...
5. Devolve a resposta exatamente nesta estrutura:
